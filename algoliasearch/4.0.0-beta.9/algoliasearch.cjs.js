...
function algoliasearch(appId, apiKey) {
    const clientOptions = {
        appId,
        apiKey,
        timeouts: {
        ...
        hostsCache: cacheCommon.createNullCache(),
    ...
    return clientSearch.createSearchClient({
        ...
        methods: {
            ...
            getPersonalizationStrategy: clientSearch.getPersonalizationStrategy,
            setPersonalizationStrategy: clientSearch.setPersonalizationStrategy,
